...
const InvestmentCard: React.FC = () => {
    ...
    return (
        <div className='border border-[3px] rounded-3xl w-[40%] flex-shrink-0 h-[75vh] mt-[-7vh]'>
            ...
            <div className='mx-20 my-6 justify-center items-center '>
                <div className='py-2'>
                    ...
                    <input className='w-full h-8 rounded-lg border border-[2px] px-1 focus:outline-none bg-[#f1f1f1]' />
                </div>
                <div className='py-2'>
