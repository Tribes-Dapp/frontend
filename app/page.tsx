  ...
  return (
    <div className='w-full'>
      <div className='relative'>
        <Image draggable={false} className='absolute right-0 -top-20 z-0' src={asset1} alt="logo" width={700} height={50} />
        <Image draggable={false} className='absolute left-0  z-0' src={asset2} alt="logo" width={900} height={50} />
      </div>
